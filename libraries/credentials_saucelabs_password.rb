...
# HWRP:: credentials_saucelabs_password
#
...
require_relative 'credentials_password'
...
class Chef
  class Provider::JenkinsSauceLabsCredentials < Provider::JenkinsPasswordCredentials
